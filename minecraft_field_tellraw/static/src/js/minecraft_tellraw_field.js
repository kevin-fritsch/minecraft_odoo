/** @odoo-module alias=minecraft_field_tellraw.minecraft_tellraw_field **/
"use strict";
...
class MinecraftTellrawHoverEventTextDialog extends Component {
  ...
  onClickSave() {
    if (this.__owl__.parent.component.state.fromEdit) {
      this.__owl__.parent.component.state.values[this.index] = this.state.value;
    } else {
      this.__owl__.parent.component.state.values.push(this.state.value);
    }
    this.__owl__.parent.component.state.fromEdit = false;
    this.props.onClosed();
  }
  onClickCancel() {
    console.log(this);
...
class MinecraftTellrawDialog extends Component {
  ...
  onClickSave() {
    ...
    this.__owl__.parent.component.state.fromEdit = false;
    this.__owl__.parent.component.state.minecraftTellrawTextDialog = false;
  }
  onClickCancel() {
    this.__owl__.parent.component.state.minecraftTellrawTextDialog = false;
  }
  ...
  _setEditValue(value) {
    ...
    this.__owl__.parent.component.state.editValue = {};
  }
...
class MinecraftTellrawField extends AbstractFieldOwl {
  get attrs() {
    const fieldsInfo = this.record.__bm_load_params__.fieldsInfo[this.viewType];
  ...
  get viewType() {
    return this.record.__viewType || "default";
  }
  get mode() {
    return this.props.record.mode;
  }
  setup() {
    super.setup();
    this.state = useState({
...
registry.category("fields").add("minecraft_tellraw_field", MinecraftTellrawField);
